...
<head>
    ...
    <script src="js/personalPage_js.js"></script>
    <!--Loading动画css-->
    ...
    <div class="header">
        <div class="row"><!-- col-lg-2 col-lg-offset-2 col-md-2 col-md-2 col-md-offset-2 col-sm-offset-3 col-xs-offset-4 col-sm-2 col-xs-4-->
            <div class="user_img_div">
                    <!--用于更换头像-->
                    <input style="display: none" type="file" accept="image/png,image/gif,image/jpeg,image/jpg" id="file" onchange="commitImage()"/>
                    <!--style="margin-left: 40%;width: inherit"-->
                    <img src="${initParam.userPath}${sessionScope.user.uimg}" onclick="clickProfile()" alt="用户头像" class="user_img img img-circle">
            </div>
            <div style="margin-top: 2%" class="col-lg-5 col-lg-offset-1 col-md-5 col-sm-5 col-xs-5 col-sm-offset-1 col-xs-offset-4">
                <span style="font-size: 35px;font-weight: 200">${sessionScope.user.uname}</span><br class="visible-xs"><br class="visible-xs">
                &nbsp;&nbsp;&nbsp;&nbsp;<a style="margin-top:-4%"class="btn btn-default" href="editPage.jsp" role="button"><img style="display: inline-block" src="icons/edit.png" class="img-responsive"><b>编辑信息</b></a>
                <br><br>
                ...
                <h4>${sessionScope.user.uwords}</h4>
            </div>
        </div>
    </div>
    <br><br>
                            ...
                            <div class="share_modal_message col-md-12 hidden-xs panel panel-default">
                                <div class="share_message_body panel-body" style="overflow-y:auto;max-height:300px">
                                    <div>
                                        ...
                                        <span class="share_collection" data-flag="1" onclick="share_collection_click()" style="margin-left: 5%"><img src="icons/black_collection.png"></span>
                                        <span class="share_delete" style="margin-left: 25%"><button class="btn btn-warning">删除</button></span><br><br>
...
<!--删除动态提示框-->
<div class="modal fade bs-example-modal-sm" tabindex="-1" data-keyboard="false" data-backdrop="false" role="dialog" aria-labelledby="mySmallModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <br>
                <div align="center"><p style="font-size: 25px;">删除成功</p></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" onclick="shareModalClose()" data-dismiss="modal">确定</button>
            </div>
        </div>
    </div>
</div>
